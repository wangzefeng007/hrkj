...
class upmp_config
{
    ...
    static $mer_id     				= "303430148160024"; // 商户号
    static $security_key    		= "WkhcKgMJuObffCxIsF8JETCt0ZfUF2zr"; // 商户密钥
//   static $mer_back_end_url     	= "http://pay.gold123.com.cn"; // 后台通知地址
    static $mer_back_end_url     	= "http://pay.gold123.com.cn/api.php/upmp/payReturn"; // 后台通知地址
