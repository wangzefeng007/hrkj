...
// 商户号
const SDK_MCHID = '802360049000501';

// 签名证书路径
const SDK_SIGN_CERT_PATH = '/home/html/www/Public/certs/acp802360049000501.pfx';

// 签名证书密码
const SDK_SIGN_CERT_PWD = '468579';

// 密码加密证书（这条一般用不到的请随便配）
const SDK_ENCRYPT_CERT_PATH = '/home/html/www/Public/certs/acp_prod_enc.cer';

// 验签证书路径（请配到文件夹，不要配到具体文件）
const SDK_VERIFY_CERT_DIR = '/home/html/www/Public/certs';
...
//文件下载目录 
const SDK_FILE_DOWN_PATH = '/home/html/www/Public/acp/';

//日志 目录 
const SDK_LOG_FILE_PATH = '/home/html/www/tmp/log/acp/';
